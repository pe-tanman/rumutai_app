            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _indentedText("a.", "ユーザーは、「HR対抗アプリ」（以下、本アプリ)を個人的な目的で利用できます。"),
                  ...
                  _indentedText("f.", "ユーザーが、本アプリ内で提供した個人情報については「プライバシーポリシー」に基づいて扱われるものとします。"),
                  const SizedBox(height: 5),
                  const Text(
                    "2. 知的財産権",
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ...
                  _indentedText("a.", "本アプリには、情報の遅れや間違いが生じる可能性があり、正確性や信頼性について保証しません。"),
                  _indentedText("b.", "本アプリは試験段階であり、サービスを停止する場合があります。この際に生じた損害について、著作者は責任を負いません。"),
